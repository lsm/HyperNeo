...
with #2779; B5j is an independent leaf**. The B5 slices that edit `sdk-message-handler.ts` or `acp-query-runner.ts` (B5f–B5i, B5k, B5l) hold §5's coordination gate on open #2543 alongside the #2779 coordination for B5d. B5's setup-window revalidation
