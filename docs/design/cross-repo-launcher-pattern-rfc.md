...
- **Setup:** for a retained-cadence goal, snapshot and clear the cadence **first**
  ...
  pause, so a due check-in could claim it in the window; then drain B's pending
