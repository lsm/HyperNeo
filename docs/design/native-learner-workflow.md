...
interface TaskProposal {
  ...
  verificationMethod: {
    ...
    window?: {
      ...
      // At least one of durationMs / absoluteDeadline / completionPredicate is required
      // so onSelfNag has a computable due condition; acceptance rejects an all-empty window.
    };
  } | null;
  acceptedSnapshot: {
    title: string;
