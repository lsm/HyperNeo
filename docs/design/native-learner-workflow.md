...
interface TaskProposal {
  ...
  verificationMethod: {
    ...
    window?: {
      ...
      // schedulable due point (an arbitrary predicate string has no timestamp comparator).
    };
  } | null;
  acceptedSnapshot: {
    title: string;
