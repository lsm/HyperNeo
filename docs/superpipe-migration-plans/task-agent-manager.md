...
| TAM-S2 | Wire `mcpSelfHeal` to the S1 pipeline; index/callback/displaced-session lifecycle effects stay class-owned; MUST NOT wire before S1's terminal-status fence (TAM-F0 + writers) is available | wire | ≲40 | ≲50 | TAM-S1 |
