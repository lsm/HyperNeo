      ...
      <div class="scrollbar-dark flex-1 overflow-y-auto px-4 py-4 pr-5 space-y-5">
        ...
        <div class="rounded-lg border border-white/10 bg-dark-850 p-3">
          ...
          <p class="mt-2 text-xs leading-5 text-gray-400">
            ...
            reaction before opening (the codex review is re-checked on a 5-minute poll, with a 2h
            timeout-allow). The matcher accepts any GitHub App bot whose login contains "codex"
            (e.g. codex[bot] or chatgpt-codex-connector[bot]).
          </p>
        </div>
