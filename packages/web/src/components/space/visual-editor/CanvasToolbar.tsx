...
export function CanvasToolbar({
  ...
  return (
    <div
      class="absolute bottom-4 right-4 flex items-center gap-1 rounded-xl border border-line bg-surface/90 px-2 py-1.5 shadow-2xl shadow-black/30 backdrop-blur select-none pointer-events-auto"
      data-testid="canvas-toolbar"
    >
      <button
        type="button"
        class="w-7 h-7 flex items-center justify-center rounded-lg text-fg-muted hover:text-fg hover:bg-fill-soft transition-colors text-base font-medium disabled:opacity-40"
      ...
      <button
        type="button"
        class="min-w-[3rem] h-7 px-1 flex items-center justify-center rounded-lg text-xs text-fg-muted hover:text-fg hover:bg-fill-soft transition-colors tabular-nums"
        onClick={handleReset}
      ...
      <div class="w-px h-4 bg-fill mx-0.5" />

      <button
        type="button"
        class="h-7 px-2 flex items-center justify-center rounded-lg text-xs text-fg-muted hover:text-fg hover:bg-fill-soft transition-colors"
