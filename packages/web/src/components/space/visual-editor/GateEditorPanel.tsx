...
export function GateEditorPanel({
  ...
  function toggleLegacyCodexMarker(checked: boolean) {
    ...
    // When disabling, also strip the migration-generated codex validator
    // (if present) so codex enforcement stops. The validator is only ever
    // generated by migration from this marker, so clearing the marker must
    // also clear it.
