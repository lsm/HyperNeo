    ...
    >
      <div class="mx-auto min-h-[calc(100%+1px)] max-w-6xl space-y-6">
        ...
        <ConfirmModal
          ...
          title="Stop Space"
          message="Stopping will pause scheduling and interrupt active agent sessions. In-progress workflow work is preserved and resumes when you start the space again; standalone in-progress tasks pause and will need a manual restart. The space will not restart automatically."
