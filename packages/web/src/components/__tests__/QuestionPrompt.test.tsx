...
describe('QuestionPrompt', () => {
  ...
  describe('Single Select Behavior', () => {
    it('should select option when clicked', () => {
      ...
      expect(editButton.className).toContain('bg-cat-rose/60');
    });
    ...
    it('should deselect previous option when new option is selected', () => {
      ...
      expect(deleteButton.className).toContain('bg-cat-rose/60');
      expect(editButton.className).not.toContain('bg-cat-rose/60');
    });
  ...
  describe('Multi Select Behavior', () => {
    it('should allow selecting multiple options', () => {
      ...
      expect(darkModeBtn.className).toContain('bg-cat-rose/60');
      expect(notificationsBtn.className).toContain('bg-cat-rose/60');
    });
    ...
    it('should toggle selection on repeated clicks', () => {
      ...
      fireEvent.click(darkModeBtn);
      expect(darkModeBtn.className).not.toContain('bg-cat-rose/60');
    });
  });
