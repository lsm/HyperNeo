...
const GOAL_STATUS_TONE_CLASSES: Record<GoalStatusTone, GoalStatusClasses> = {
  ...
  info: {
    ...
    soft: 'border-accent/30 bg-accent/10 text-accent-soft',
  ...
  success: {
    ...
    soft: 'border-success/30 bg-success/10 text-success-soft',
  ...
  warning: {
    ...
    soft: 'border-warning/30 bg-warning/10 text-warning-soft',
