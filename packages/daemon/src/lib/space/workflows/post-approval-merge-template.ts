...
export const PR_MERGE_POST_APPROVAL_INSTRUCTIONS: string = [
  ...
  '        C2 Pending review in progress / C3 required team review / C4 dismissed',
  '           review request: go to step h to re-engage the reviewer/team.',
  ...
  '      a blocker — never sit and poll. EXCEPTION: a CHECK that is genuinely',
  '      IN_PROGRESS / pending is NOT an actionable blocker — wait for it to',
  '      finish (re-check with `gh pr checks {{pr_url}} --required --watch` or a',
  '      periodic re-query) instead of messaging or escalating. (A pending REVIEW',
  '      is still actionable — see C2.) After a routed blocker is resolved, re-run',
