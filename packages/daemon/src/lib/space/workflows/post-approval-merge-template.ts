...
export const PR_MERGE_POST_APPROVAL_INSTRUCTIONS: string = [
  ...
  '           auto-merge — wait for the check to finish, then RE-RUN steps 1 and 2',
  '           (the wait window can let a reviewer request changes or open a thread)',
  '           before retrying the step-3 merge. Only proceed to steps 4-6 once',
