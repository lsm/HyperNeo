...
export const PR_MERGE_POST_APPROVAL_INSTRUCTIONS: string = [
  ...
  '      mechanics). mergeStateStatus from step 1 already narrows the category:',
  ...
  '      a blocker — never sit and poll. After a routed blocker is resolved (coder',
  '      pushes, a check reruns green, or step h returns), re-run the step 1 and',
  '      step 2 checks, then retry the merge. If NO Category A-F item matches the',
