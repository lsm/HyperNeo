...
export const PR_MERGE_POST_APPROVAL_INSTRUCTIONS: string = [
  ...
  '      request changes from the coder — reuse the pr_url + review_url handoff',
  '      from step c (review-posted-gate resets each cycle, so a bare follow-up',
  '      is blocked) — instead of merging. Only then re-attempt',
