...
export const PR_MERGE_POST_APPROVAL_INSTRUCTIONS: string = [
  ...
  '      Take the `html_url` of the latest APPROVED review. If GitHub blocked',
  '      self-review and the reviewer used a PR conversation comment instead (a',
  '      valid evidence path the gate accepts), fall back to the latest comment',
  '      permalink:',
