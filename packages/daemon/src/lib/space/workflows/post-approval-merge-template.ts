...
export const PR_MERGE_POST_APPROVAL_INSTRUCTIONS: string = [
  ...
  '      and inspect the FULL delta since the approved head — the conflict',
  ...
  '   same-named branch. Check first, then delete only if non-cross-repo:',
  '     gh pr view {{pr_url}} --json isCrossRepository,headRefName',
  '   If isCrossRepository is true, SKIP deletion. Otherwise delete the ref:',
