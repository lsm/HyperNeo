...
export const PR_MERGE_POST_APPROVAL_INSTRUCTIONS: string = [
  ...
  '      the coder PUSHED to resolve it (A9/A10/B3/D1/D4), first recover the',
  '      APPROVED head = the commit_id of the latest APPROVED/COMMENTED review',
  '      (`gh api --hostname <host> repos/<owner>/<repo>/pulls/<number>/reviews`,',
  '      latest APPROVED/COMMENTED `.commit_id` — step 1 captures no headRefOid',
