...
const BUILT_IN_PROMPT_PATCH_VARIANTS = [
  ...
  [[CODER_ONLY_PROMPT, RETIRED_PRE_DE_POLL_CODER_ONLY_PROMPT]],
  [[CODER_OWNED_MERGE_PROMPT, RETIRED_PRE_DE_POLL_CODER_OWNED_MERGE_PROMPT]],
  [[RESEARCH_PROMPT, RETIRED_PRE_DE_POLL_RESEARCH_PROMPT]],
  [[CODEX_REACTION_APPROVAL_GUIDANCE, RETIRED_PRE_DE_POLL_CODEX_REACTION_APPROVAL_GUIDANCE]],
  [
    [CURRENT_FULLSTACK_REVIEW_HANDOFF_PROMPT, RETIRED_FULLSTACK_REVIEW_HANDOFF_PROMPT],
    [CODEX_REACTION_APPROVAL_GUIDANCE, RETIRED_PRE_DE_POLL_CODEX_REACTION_APPROVAL_GUIDANCE],
  ],
