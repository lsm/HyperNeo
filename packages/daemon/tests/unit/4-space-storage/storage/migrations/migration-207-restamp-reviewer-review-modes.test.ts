...
import {
  ...
  runMigration207,
} from '../../../../../src/storage/schema/m207-restamp-reviewer-review-modes.ts';
...
describe('migration 207 — reviewer depth-tiers contract restamp', () => {
  test('re-stamps a pristine Reviewer row carrying the pre-review-modes contract', () => {
    const spaceId = 'space-m207-a';
  ...
  test('leaves a customized Reviewer row untouched', () => {
    ...
    const otherSpaceId = 'space-m207-c2';
