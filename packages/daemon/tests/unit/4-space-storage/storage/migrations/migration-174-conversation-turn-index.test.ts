...
import { runMigration174 } from '../../../../../src/storage/schema/migrations';

/**
 * The pre-174 `sdk_messages` shape: has the columns the backfill reads
 ...
 */
function createPre174SdkMessages(db: BunDatabase): void {
  db.exec(`
...
describe('Migration 174: conversation_turn_index backfill + index', () => {
  let db: BunDatabase;
