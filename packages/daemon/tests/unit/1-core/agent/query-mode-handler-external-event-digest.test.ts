...
=======
    it('flag on: a null digest-pull result excludes deterministic digest rows from the flush', async () => {
...
>>>>>>> d33d86e542 (fix(daemon): restrict turn-end flushes to certified digest outcomes)
      pullImpl = async () => ({
        action: 'failed',
...
=======
    ...
    it('flag on: a delivered outcome only flushes its certified digest row', async () => {
      pullImpl = async () => ({
        action: 'delivered',
    ...
    it('flag on: a safe skip outcome flushes deferred digest rows', async () => {
    ...
    it('flag on: an unsafe skip outcome excludes deterministic digest rows', async () => {
      pullImpl = async () => ({
        action: 'skip',
    ...
    it('flag on: a held outcome excludes deterministic digest rows', async () => {
      pullImpl = async () => ({
        action: 'held',
        reason: 'append_error',
