...
- **Durable / >7-day / goal- or evolution-linked schedules** → `invoke(name="schedule.create", input={...})` on the `operations` MCP server. These persist across sessions and daemon restarts.
