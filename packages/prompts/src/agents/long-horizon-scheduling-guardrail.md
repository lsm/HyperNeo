...
- **Durable / >7-day / goal- or forge-linked schedules** → `call_action(name="create_scheduled_task", params={...})` on the `space-actions` MCP server. These persist across sessions and daemon restarts.
