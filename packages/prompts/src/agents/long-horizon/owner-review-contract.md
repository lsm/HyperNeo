...
- **Create follow-up work** from reviews: if it belongs to the goal, trigger the goal again with `goal.task.trigger` so the next iteration stays linked and reports back to you; otherwise use ordinary task tools. Do not hold follow-ups in your head.
