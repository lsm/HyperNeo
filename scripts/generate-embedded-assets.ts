...
const SKILLS_OUTPUT_FILE = join(ROOT, 'packages/cli/src/embedded-skills.ts');
...
writeFileSync(SKILLS_OUTPUT_FILE, skillsOutput);
console.log(
...
console.log(`Generated ${SKILLS_OUTPUT_FILE} with ${skillMapEntries.length} built-in skill files`);
