...
HASH_SPLIT_SPECS=(
	"5-space|2|5-space/*.test.ts;5-space/actions/*.test.ts;5-space/agent/*.test.ts;5-space/goals/*.test.ts;5-space/mailbox/*.test.ts;5-space/other/*.test.ts;5-space/tools/*.test.ts;5-space/workflow/*.test.ts;5-space/runtime/*.test.ts;5-space/runtime/connectors/*.test.ts;5-space/workspaces/*.test.ts|scripts/shard-weights.tsv"
)
