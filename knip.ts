...
const config: KnipConfig = {
  ...
  ignoreIssues: {
    ...
    'packages/daemon/src/lib/space/mailbox/bridge.ts': ['exports'],
    'packages/daemon/src/lib/space/mailbox/delivery.ts': ['exports'],
    'packages/daemon/src/lib/space/mailbox/enqueue.ts': ['exports'],
    'packages/daemon/src/lib/space/mailbox/handoff.ts': ['exports'],
    'packages/daemon/src/lib/space/mailbox/resolution.ts': ['exports'],
    'packages/daemon/src/lib/space/mailbox/settlement.ts': ['exports'],
    'packages/daemon/src/lib/space/mailbox/spawn.ts': ['exports'],
